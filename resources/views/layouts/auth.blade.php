<!DOCTYPE html>
    {{-- auth.blade.php - Auth - Backpack For Laravel Admin Panel
...
<body class="{{ backpack_theme_config('classes.body') }} @if(backpack_theme_config('auth_layout') === 'cover') flex flex-col theme-light @endif">
