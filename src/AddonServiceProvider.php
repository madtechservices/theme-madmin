...
class MadminServiceProvider extends ServiceProvider
{
    ...
    // {
        ...
        // $this->publishes([
        //     __DIR__.'/resources/views' => resource_path('views/vendor/theme-madmin'),
        // ], 'views');
        // $this->publishes([
        //     __DIR__.'/resources/lang' => resource_path('lang/vendor/theme-madmin'),
        // ], 'lang');
        // $this->publishes([
        //     __DIR__.'/resources/assets' => public_path('vendor/theme-madmin'),
        // ], 'public');
        // $this->publishes([
