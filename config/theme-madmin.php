...
return [
    ...
    */
    ...
    // NOTICE: For faster modification and further flexibility including lots more features for your 
    // backpack admin panel, concider adding the MADmin-Settings package. More information available
    // at https://github.com/madtechservices/madmin-settings
    //
    // MADmin settings allows complete customisation of your Backpack admin panel all via a simple 
    // to use UI inside your Backpack Admin Panel.
    ...
    #'layout' => 'vertical_custom',

    /**
     * Pick a login page layout.
     * Possible values: default, illustration, cover, clean, video, custom
     */
    'auth_layout' => 'default',
    #'auth_layout' => 'illustration',
    #'auth_layout' => 'cover',
    #'auth_layout' => 'clean',
    #'auth_layout' => 'video',
    #'auth_layout' => 'custom',
     ...
     *   - make a copy of the file "vendor/madtechservices/theme-madmin/resources/assets/css/colors.css" into your project
     *   - adjust colors variables as you wish
     *   - replace "base_path('vendor/madtechservices/theme-madmin/resources/assets/css/colors.css')," with the path to the file created above
     *   - boom!
     */
    'styles' => [
        base_path('vendor/madtechservices/theme-madmin/resources/assets/css/color-adjustments.css'),
        base_path('vendor/madtechservices/theme-madmin/resources/assets/css/colors.css'),
    ],
